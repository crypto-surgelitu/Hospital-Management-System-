...
if (!$drug_id) {
    header('Location: /hms/hms/modules/pharmacy/inventory.php');
    exit;
}
...
if (!empty($errors)) {
    ...
    $_SESSION['old'] = $_POST;
    header('Location: /hms/hms/modules/pharmacy/drug_form.php?id=' . $drug_id);
    exit;
}
...
header('Location: /hms/hms/modules/pharmacy/inventory.php?success=updated');
exit;